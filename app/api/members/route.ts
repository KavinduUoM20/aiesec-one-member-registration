...
import Member, { iMember, insertMembersIfNotExist } from "@/app/models/Member";
import { json } from "body-parser";
import { requestGraphQL } from "@/app/utils/graphql";
...
export async function GET() {
  try {
    ...
    return Response.json({ message: "Error in fetching" }, { status: 500 });
  }
}
